...
export default function page() {
  return (
    <div className=''>
      <div className='font-semibold text-xl mb-5'>Welcome to Static Page</div>
      <div className='mb-3'>
      ...
      <div>Pretty cool, right? Now navigate to the `Client Page` to check how interactivity is added in Next.js!</div>
    </div>
  )
}
